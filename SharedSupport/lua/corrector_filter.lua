--[[
	Trouble-sounding and typo prompts.
	Example: The correct pronunciation of "giving" is ji yu. When the user enters gei yu, the correct pronunciation is displayed in the comment of the candidate.
	Example: The correct way to write "pressure" is "pressure". When the user enters "pressure" and the correct way to write it in the comment of the candidate
