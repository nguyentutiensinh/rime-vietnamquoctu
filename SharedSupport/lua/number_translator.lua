...
-- Split the string of numbers into four digits in the thousandths and convert them into Chinese
...
-- Convert numerical values ​​to Chinese
...
-- The trigger mode starts with any capital letter (except U, which is used in Unicode) and can be customized in recognizer/patterns
