...
-- YummyCocoa修改: 
--   1. Without setting mode, adjust to the default full-down mode (originally none mode);
--   2. all The default fully-down content and custom content will be merged.
